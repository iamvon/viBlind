...
class Predictor(object):
    ...
    def __init__(self, model=None, tokenizer=None, normalize=True,
        ...
        #<class 'ml_core.drqa.tokenizers.corenlp_tokenizer.CoreNLPTokenizer'>
    ...
    def predict(self, document: object, question: object, candidates: object = None, top_n: object = 1) -> object:
